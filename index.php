...
<body>
  <div class="container mx-auto px-4 pt-5">
    ...
    <a href="http://localhost/server-pengajar/add.php" class="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-sm text-white my-2">Tambah mahasiswa</a>
        ...
        <?php foreach ($mahasiswa as $mhs) : ?>
          <tr>
            ...
            <td class="border text-center py-3">
              <a href="http://localhost/server-pengajar/info.php?id=<?= $mhs['mhs_id']; ?>" class="bg-blue-500 hover:bg-tael-600 focus:outline-none focus:shadow-outline py-1 px-3 mx-1 rounded-md text-white">
                <i class="fa fa-info-circle"></i>
              </a>
              <a href="http://localhost/server-pengajar/edit.php?id=<?= $mhs['mhs_id']; ?>" class="bg-yellow-500 hover:bg-tael-600 focus:outline-none focus:shadow-outline py-1 px-3 mx-1 rounded-md text-white">
                <i class="fa fa-edit"></i>
              </a>
              <a href="http://localhost/server-pengajar/delete.php?id=<?= $mhs['mhs_id']; ?>" class="bg-red-500 hover:bg-tael-600 focus:outline-none focus:shadow-outline py-1 px-3 mx-1 rounded-md text-white" onclick="confirm('Hapus?')">
