  ...
  <div class="h-screen bg-indigo-100  w-full mx-auto flex flex-col justify-center content-center">
    <div class="w-5/6 h-5/6 flex bg-indigo-400 mx-auto rounded-md shadow-xl">
      ...
      <div class="w-1/2 py-10 px-20">
        <h1 class="text-5xl font-bold mb-5 text-white">Tambah Mata Kuliah</h1>
        ...
        <form action="" method="post">
          ...
          <input type='text' name="kode_mk" maxlength="10" placeholder="Enter Kode Mata Kuliah" class="w-full mt-2 mb-6 px-3 py-1 border rounded-lg text-md text-gray-700 focus:outline-none" required />
          <label class="text-white font-light">Nama Mata Kuliah</label>
          <input type='text' name="nama_mk" placeholder="Enter nama" class="w-full mt-2 mb-6 px-3 py-1 border rounded-lg text-md text-gray-700 focus:outline-none" required />
          <label class="text-white font-light">Semester</label>
          <input type='text' name="semester" placeholder="Enter semester" class="w-full mt-2 mb-6 px-3 py-1 border rounded-lg text-md text-gray-700 focus:outline-none" required />
