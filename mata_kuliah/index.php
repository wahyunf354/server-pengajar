      ...
      <?php foreach ($matakuliah as $mk) : ?>
        <tr>
          ...
          <td class="border text-center py-3">
            <a href="http://localhost/server-pengajar/mata_kuliah/info.php?id=<?= $mk['mk_id']; ?>" class="bg-blue-500 hover:bg-tael-600 focus:outline-none focus:shadow-outline py-1 px-3 mx-1 rounded-md text-white">
              <i class="fa fa-info-circle"></i>
            </a>
            <a href="http://localhost/server-pengajar/mata_kuliah/edit.php?id=<?= $mk['mk_id']; ?>" class="bg-yellow-500 hover:bg-tael-600 focus:outline-none focus:shadow-outline py-1 px-3 mx-1 rounded-md text-white">
              <i class="fa fa-edit"></i>
            </a>
            <a href="http://localhost/server-pengajar/mata_kuliah/delete.php?id=<?= $mk['mk_id']; ?>" class="bg-red-500 hover:bg-tael-600 focus:outline-none focus:shadow-outline py-1 px-3 mx-1 rounded-md text-white" onclick="confirm('Hapus?')">
