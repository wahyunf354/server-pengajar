...
<div class="pb-10">
  ...
  <a href="http://47.254.247.28:85/mata_kuliah/add.php" class="bg-red-500 hover:bg-red-600 px-4 py-2 rounded-sm text-white my-2">Tambah Mata Kuliah</a>
      ...
      <?php foreach ($matakuliah as $mk) : ?>
        <tr>
          ...
          <td class="border text-center py-3">
            <a href="http://47.254.247.28:85/mata_kuliah/info.php?id=<?= $mk['mk_id']; ?>" class="hover:text-blue-600 focus:outline-none focus:shadow-outline py-1 px-1 rounded-md text-white">
              <i class="fill-current text-blue-500 material-icons">help</i>
            </a>
            <a href="http://47.254.247.28:85/mata_kuliah/edit.php?id=<?= $mk['mk_id']; ?>" class="hover:text-yellow-600 focus:outline-none focus:shadow-outline py-1 px-1 rounded-md text-white">
              <i class="fill-current text-yellow-500 material-icons">edit</i>

            </a>
            <a href="http://47.254.247.28:85/mata_kuliah/delete.php?id=<?= $mk['mk_id']; ?>" class="hover:text-red-600 focus:outline-none focus:shadow-outline py-1 px-1 rounded-md text-white" onclick="confirm('Hapus?')">
