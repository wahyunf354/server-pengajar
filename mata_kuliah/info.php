...
<main class="pb-10 flex">
  <div class="px-5 flex-none">
    ...
    <a href="add_nilai.php?id=<?= $mk['mk_id']; ?>" class="block text-center cursor-pointer bg-red-500 text-white hover:bg-red-600 px-3 py-2 mt-5 rounded">Input Nilai</a>
  </div>
          ...
          <tbody>
            ...
            <?php foreach ($nilai as $n) : ?>
              <tr class="w-full font-light text-gray-700 bg-gray-100 whitespace-no-wrap border border-b-0">
                ...
                <td class="px-4 py-4"><?= $n['nama']; ?></td>
                <td class="px-4 py-4">
                  <?= $n['nilai']; ?>
                </td>
                <td class="text-center py-4">
                  <a href="edit_nilai.php?id=<?= $mk['mk_id']; ?>&nilai_id=<?= $n['nilai_id']; ?>"><span class="fill-current text-green-500 material-icons">edit</span></a>
                  <a href="hapus_nilai.php?id=<?= $mk['mk_id']; ?>&nilai_id=<?= $n['nilai_id']; ?>"><span class="fill-current text-red-500 material-icons">highlight_off</span></a>
                </td>
              </tr>
              <?php $no++; ?>
            <?php endforeach; ?>
